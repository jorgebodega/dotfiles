...
function M.set(cap, bufnr)
    ...
    buf_set_keymap('v', '<leader>fa', "<cmd>'<,'>lua require('lspsaga.codeaction').range_code_action()<CR>", opts) ]]
        ...
        buf_set_keymap('n', '<leader>fo',
                       '<cmd>lua require("lt.lsp.functions").organize_imports()<CR>',
                       opts)
    end
  ...
  buf_set_keymap('n',']e', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>', opts) ]]
    ...
    buf_set_keymap('n', '<leader>fcd',
                   ':lua print(vim.inspect(vim.lsp.get_active_clients()))<CR>',
                   opts)
    buf_set_keymap('n', '<leader>fcl', ":lua print(vim.lsp.get_log_path())<CR>",
                   opts)
